...
Deepgrep, ham taramanın güçlü olduğu durumlarda paralel arama motorunu kullanır;
tekrarlanan sorgularda ise `.deepgrep-v3` indeksinden yararlanarak aranacak dosya
sayısını güvenli biçimde azaltır.
...
- Kendi indeks klasörü dışındaki gizli veri klasörlerine dokunmadığı test edilir.
